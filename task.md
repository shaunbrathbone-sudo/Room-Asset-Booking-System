...
| 2026-08-16 | Office Welcome Guide & Admin CMS | Implemented the full 17 Friar Lane Induction & Welcome Guide (/explore/united-kingdom/leicester-hub/guide) covering Arrival, Parking, Workspaces, Amenities, Desk Booking, and Local Hotspots; built the Admin Guide Content Manager (/admin/offices/[slug]/guide) with live saving and dual-database support. |
